...
function updateSidebar(role) {
    ...
    if (['Master','Admin','Developer'].includes(role)) document.getElementById('admin-links').classList.remove('hidden');
...
function addMarks() {
    ...
    } else alert("Error finding student");
}
...
function renderUserList() {
    ...
    Object.keys(users).forEach(key => {
        ...
        // Master/Friday see ALL. Admins hide special roles.
